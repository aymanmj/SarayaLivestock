  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="relative rounded-3xl bg-gradient-to-r from-slate-900 via-emerald-950/40 to-slate-900 border border-emerald-500/30 p-8 md:p-10 shadow-2xl overflow-hidden">
        <div className="absolute top-0 left-0 w-80 h-80 bg-emerald-100 dark:bg-emerald-500/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
          <div className="flex items-center gap-5">
            <div className="w-20 h-20 rounded-3xl bg-gradient-to-tr from-emerald-600 via-emerald-500 to-teal-400 flex items-center justify-center text-slate-900 dark:text-white shadow-2xl shadow-emerald-900/50 shrink-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 rounded-3xl bg-white/80 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 shadow-xl space-y-4">
          <div className="flex items-center gap-3">
            <div className="p-3 rounded-2xl bg-emerald-100 dark:bg-emerald-500/10 border border-emerald-300 dark:border-emerald-500/20 text-emerald-700 dark:text-emerald-400">
              <Building2 className="w-6 h-6" />
            </div>
            <div>
              <span className="text-xs font-semibold text-slate-500 dark:text-slate-400">الشركة المالكة والمطورة:</span>
              <h3 className="text-lg font-bold text-slate-900 dark:text-white">السرايا للتقنية (Al-Saraya for Technology)</h3>
            </div>
          </div>
          ...
          <div className="pt-2 border-t border-slate-200/80 dark:border-slate-800/80 space-y-2 text-xs">
            <div className="flex items-center justify-between p-2.5 rounded-xl bg-slate-100/50 dark:bg-slate-800/50 border border-slate-300/60 dark:border-slate-700/60">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-emerald-700 dark:text-emerald-400 hover:text-emerald-300 font-mono font-bold flex items-center gap-1 transition"
              >
                www.alsarayatech.ly
        ...
        <div className="p-6 rounded-3xl bg-white/80 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 shadow-xl space-y-4">
          <div className="flex items-center gap-3">
            <div className="p-3 rounded-2xl bg-blue-100 dark:bg-blue-500/10 border border-blue-500/20 text-blue-600 dark:text-blue-400">
              <User className="w-6 h-6" />
            </div>
            <div>
              <span className="text-xs font-semibold text-slate-500 dark:text-slate-400">المطور والمهندس المسؤول:</span>
              <h3 className="text-lg font-bold text-slate-900 dark:text-white">المهندس / أيمن جاب الله</h3>
            </div>
          </div>
          ...
          <div className="pt-2 border-t border-slate-200/80 dark:border-slate-800/80 space-y-2 text-xs">
            <div className="flex items-center justify-between p-2.5 rounded-xl bg-slate-100/50 dark:bg-slate-800/50 border border-slate-300/60 dark:border-slate-700/60">
              <span className="flex items-center gap-2 text-slate-700 dark:text-slate-300">
                <Phone className="w-4 h-4 text-cyan-700 dark:text-cyan-400" />
                رقم الهاتف / الدعم:
              </span>
              <div className="flex items-center gap-2">
                <span className="text-slate-900 dark:text-white font-mono font-bold">0916523434</span>
                <button
                  onClick={() => handleCopy('0916523434', 'phone')}
                  className="p-1 rounded bg-slate-200 dark:bg-slate-700 hover:bg-slate-600 text-slate-700 dark:text-slate-300 transition"
                  title="نسخ الرقم"
                >
            ...
            {copied && (
              <div className="text-[11px] text-emerald-700 dark:text-emerald-400 text-center font-bold animate-in fade-in">
      ...
      <div className="bg-white/60 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          <div className="p-4 rounded-2xl bg-slate-100/40 dark:bg-slate-800/40 border border-slate-300/60 dark:border-slate-700/60 space-y-2">
      ...
      {/* Copyright Notice */}
      <div className="text-center text-xs text-slate-500 py-4 border-t border-slate-200 dark:border-slate-800">
        جميع الحقوق محفوظة © 2026 لـ <strong className="text-slate-700 dark:text-slate-300">شركة السرايا للتقنية</strong> (Al-Saraya for Technology).
      </div>
    </div>
  );
};
