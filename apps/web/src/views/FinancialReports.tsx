...
export const FinancialReports: React.FC = () => {
  ...
  if (!financialData) {
    return <div className="p-8 text-center text-slate-400">جاري تحميل البيانات المالية...</div>;
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 self-start md:self-auto">
          ...
          <button
            onClick={handlePrint}
            className="px-3.5 py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-xl font-bold text-xs flex items-center gap-1.5 transition border border-slate-700"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg">
          <div className="flex items-center justify-between mb-2">
            <span className="text-slate-400 text-xs font-medium">صافي الأرباح التشغيلية</span>
            <div className="p-2 bg-emerald-500/10 text-emerald-400 rounded-xl">
              <TrendingUp className="w-5 h-5" />
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-black text-emerald-400">{formatMoney(farmPnL.netProfit)}</span>
          </div>
          <div className="flex items-center gap-1.5 mt-2">
            <span className="text-[11px] font-bold text-emerald-400">هامش ربح {formatPercent(farmPnL.profitMarginPct)}</span>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg">
          <div className="flex items-center justify-between mb-2">
            <span className="text-slate-400 text-xs font-medium">التكلفة الفعلية للتر الحليب</span>
            <div className="p-2 bg-blue-500/10 text-blue-400 rounded-xl">
              <Milk className="w-5 h-5" />
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-black text-white">{formatMoney(milkEconomics.actualCostPerLiter, true, 3)}</span>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg">
          <div className="flex items-center justify-between mb-2">
            <span className="text-slate-400 text-xs font-medium">تكلفة كجم اللحم المضاف</span>
            <div className="p-2 bg-purple-500/10 text-purple-400 rounded-xl">
              <Scale className="w-5 h-5" />
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-black text-white">{formatMoney(beefEconomics.costPerKgGain)}</span>
            <span className="text-xs text-slate-400">/ كجم لحم</span>
          </div>
          <p className="text-[11px] text-purple-400 mt-2 font-bold">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg">
          <div className="flex items-center justify-between mb-2">
            <span className="text-slate-400 text-xs font-medium">الماشية المرشحة للاستبعاد</span>
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-400">رؤوس غير مجدية</span>
          </div>
      ...
      {activeTab === 'dairy' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="p-4 bg-slate-950/60 border border-slate-800 rounded-2xl space-y-1">
                <span className="text-[11px] text-slate-400 block">تكلفة الأعلاف (TMR):</span>
                <span className="text-xl font-black text-amber-400">{formatMoney(milkEconomics.feedCost)}</span>
              ...
              <div className="p-4 bg-slate-950/60 border border-slate-800 rounded-2xl space-y-1">
                <span className="text-[11px] text-slate-400 block">الأدوية والرعاية البيطرية:</span>
                <span className="text-xl font-black text-blue-400">{formatMoney(milkEconomics.vetCost)}</span>
                <span className="text-[10px] text-slate-500 block">
              ...
              <div className="p-4 bg-slate-950/60 border border-slate-800 rounded-2xl space-y-1">
                <span className="text-[11px] text-slate-400 block">العمالة والمصروفات الإدارية:</span>
                <span className="text-xl font-black text-purple-400">{formatMoney(milkEconomics.laborAndOverhead)}</span>
                <span className="text-[10px] text-slate-500 block">
            ...
            <div className="p-4 bg-slate-950/70 border border-slate-800 rounded-2xl space-y-3">
              <div className="flex justify-between text-xs">
                <span className="text-slate-400">سعر بيع اللتر: <strong className="text-white">{formatMoney(milkEconomics.sellingPricePerLiter, true, 3)}</strong></span>
                <span className="text-slate-400">التكلفة: <strong className="text-red-400">{formatMoney(milkEconomics.actualCostPerLiter, true, 3)}</strong></span>
                <span className="text-slate-400">صافي الربح: <strong className="text-emerald-400">{formatMoney(milkEconomics.profitPerLiter, true, 3)} ({formatPercent(milkEconomics.marginPct)})</strong></span>
              </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl space-y-4">
            <h4 className="font-bold text-white text-sm">مؤشرات قطاع الألبان</h4>
            <div className="space-y-3 text-xs">
              <div className="flex justify-between p-3 bg-slate-950/60 rounded-xl border border-slate-800">
                <span className="text-slate-400">إجمالي الحليب المنتج:</span>
                <strong className="text-white">{formatNumber(milkEconomics.totalMilkLiters)} لتر</strong>
              </div>
              <div className="flex justify-between p-3 bg-slate-950/60 rounded-xl border border-slate-800">
                <span className="text-slate-400">إجمالي مبيعات الحليب:</span>
                <strong className="text-emerald-400 font-bold">{formatMoney(milkEconomics.grossRevenue)}</strong>
              </div>
              <div className="flex justify-between p-3 bg-slate-950/60 rounded-xl border border-slate-800">
                <span className="text-slate-400">إجمالي مصروفات القطاع:</span>
                <strong className="text-red-400 font-bold">{formatMoney(milkEconomics.totalCost)}</strong>
              </div>
              <div className="flex justify-between p-3 bg-emerald-500/10 rounded-xl border border-emerald-500/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 bg-slate-950/60 border border-slate-800 rounded-2xl space-y-1">
                <span className="text-xs text-slate-400 block">إجمالي الزيادة الوزنية للقطيع:</span>
                <span className="text-2xl font-black text-amber-400">{formatNumber(beefEconomics.totalGainKg)} كجم</span>
                <span className="text-[11px] text-slate-500 block">خلال {financialData.period}</span>
              </div>

              <div className="p-4 bg-slate-950/60 border border-slate-800 rounded-2xl space-y-1">
                <span className="text-xs text-slate-400 block">تكلفة كجم اللحم المضاف:</span>
                <span className="text-2xl font-black text-emerald-400">{formatMoney(beefEconomics.costPerKgGain)}</span>
            ...
            <div className="p-4 bg-slate-950/70 border border-slate-800 rounded-2xl space-y-2 text-xs">
              <div className="flex justify-between">
                <span className="text-slate-400">سعر بيع كجم اللحم الحي القائم:</span>
                <strong className="text-white">{formatMoney(beefEconomics.marketPricePerKg)} / كجم</strong>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">صافي الربح لكل كيلوجرام مضاف:</span>
                <strong className="text-emerald-400">{formatMoney(beefEconomics.marketPricePerKg - beefEconomics.costPerKgGain)} / كجم</strong>
              </div>
              <div className="flex justify-between pt-2 border-t border-slate-800">
                <span className="text-slate-300 font-bold">هامش الربحية لقطاع التسمين:</span>
                <strong className="text-purple-400 font-black text-sm">{formatPercent(beefEconomics.profitMarginPct)}</strong>
              </div>
            </div>
          </div>

          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl space-y-4">
            <h4 className="font-bold text-white text-sm">ملخص قطاع التسمين</h4>
            <div className="space-y-3 text-xs">
              <div className="flex justify-between p-3 bg-slate-950/60 rounded-xl border border-slate-800">
                <span className="text-slate-400">القيمة السوقية المضافة:</span>
                <strong className="text-emerald-400 font-bold">{formatMoney(beefEconomics.grossEstimatedRevenue)}</strong>
              </div>
              <div className="flex justify-between p-3 bg-slate-950/60 rounded-xl border border-slate-800">
                <span className="text-slate-400">تكلفة علف التسمين:</span>
                <strong className="text-amber-400 font-bold">{formatMoney(beefEconomics.feedCost)}</strong>
              </div>
              <div className="flex justify-between p-3 bg-slate-950/60 rounded-xl border border-slate-800">
                <span className="text-slate-400">إجمالي تكلفة التسمين:</span>
                <strong className="text-red-400 font-bold">{formatMoney(beefEconomics.totalCost)}</strong>
              </div>
              <div className="flex justify-between p-3 bg-purple-500/10 rounded-xl border border-purple-500/30">
                <span className="text-purple-300 font-bold">صافي أرباح التسمين:</span>
                <strong className="text-purple-400 font-extrabold text-sm">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl space-y-5">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <button
              ...
              className="px-3.5 py-2 bg-red-600/20 hover:bg-red-600 text-red-300 hover:text-white rounded-xl text-xs font-bold transition border border-red-500/30 flex items-center gap-1.5 self-start"
            >
          ...
          <div className="space-y-3">
            {cullingList.map(cand => (
              <div
                key={cand.id}
                className="p-4 bg-slate-950/70 border border-slate-800 hover:border-slate-700 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-4 transition"
              >
                <div className="space-y-1.5">
                  <div className="flex items-center gap-2.5">
                    <span className="font-black text-white text-sm">{cand.tagNumber}</span>
                    <span className="text-xs text-slate-400">({cand.breed})</span>
                ...
                <div className="flex md:flex-col items-center md:items-end justify-between gap-2 shrink-0 border-t md:border-t-0 pt-3 md:pt-0 border-slate-800">
                  <div className="text-right">
                    <span className="text-[11px] text-slate-400 block">قيمة البيع التقديرية:</span>
                    <strong className="text-emerald-400 font-black text-base">{formatMoney(cand.estimatedSalvageValue)}</strong>
                  </div>
                  <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-5 bg-slate-950/60 border border-slate-800 rounded-2xl space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-white text-sm">كشف جرد القطيع الشامل (Herd Directory)</h4>
                  <p className="text-xs text-slate-400">أرقام القروء، الشرائح، السلالات، الأعمار، وشجرة النسب</p>
                </div>
              </div>
              <button
                onClick={() => handleExportCSV('animals', 'سجل القطيع والماشية')}
                className="w-full py-2.5 bg-slate-800 hover:bg-emerald-600 text-slate-200 hover:text-white rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition"
              >
                <Download className="w-4 h-4" />
            ...
            <div className="p-5 bg-slate-950/60 border border-slate-800 rounded-2xl space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-white text-sm">سجل إنتاج الحلب اليومي والشهري</h4>
                  <p className="text-xs text-slate-400">ورديات الحلب، الإنتاج باللتر، نسبة الدهن، وحليب العزل</p>
                </div>
              </div>
              <button
                onClick={() => handleExportCSV('milking', 'سجل الحلب الشهري')}
                className="w-full py-2.5 bg-slate-800 hover:bg-blue-600 text-slate-200 hover:text-white rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition"
              >
                <Download className="w-4 h-4" />
            ...
            <div className="p-5 bg-slate-950/60 border border-slate-800 rounded-2xl space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-white text-sm">كشف التناسل والتلقيح والسونار</h4>
                  <p className="text-xs text-slate-400">مواعيد السونار، قشات السائل المنوي، مواعيد التجفيف والولادات</p>
                </div>
              </div>
              <button
                onClick={() => handleExportCSV('breeding', 'سجل التناسل والولادات')}
                className="w-full py-2.5 bg-slate-800 hover:bg-purple-600 text-slate-200 hover:text-white rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition"
              >
                <Download className="w-4 h-4" />
            ...
            <div className="p-5 bg-slate-950/60 border border-slate-800 rounded-2xl space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-white text-sm">مستودع خامات الأعلاف وحركات الصرف</h4>
                  <p className="text-xs text-slate-400">أرصدة الخامات، أسعار الشراء، وحركات صرف العليقة للحظائر</p>
                </div>
              </div>
              <button
                onClick={() => handleExportCSV('nutrition', 'مخزون وحركات الأعلاف')}
                className="w-full py-2.5 bg-slate-800 hover:bg-amber-600 text-slate-200 hover:text-white rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition"
              >
                <Download className="w-4 h-4" />
